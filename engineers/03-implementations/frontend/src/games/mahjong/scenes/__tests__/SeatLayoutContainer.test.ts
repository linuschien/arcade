...
describe('SeatLayoutContainer Unit Tests', () => {
  ...
  it('should render directional arrows in HUD matching seat orientation', () => {
    ...
    expect((seat0 as any).hudText.setText).toHaveBeenCalledWith('▼ [東風] 賭神');
    ...
    expect((seat1 as any).hudText.setText).toHaveBeenCalledWith('▶ [南風] 賭俠小刀');
    ...
    expect((seat2 as any).hudText.setText).toHaveBeenCalledWith('▲ [西風] 賭聖阿星');
    ...
    expect((seat3 as any).hudText.setText).toHaveBeenCalledWith('◀ [北風] 賭霸有喜');
  });
