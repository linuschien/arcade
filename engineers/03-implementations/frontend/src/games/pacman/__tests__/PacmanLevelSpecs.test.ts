...
describe('PacmanLevelSpecs Unit Tests', () => {
  it('should return correct Level 1 specs with linear initial speed ratios', () => {
  ...
  it('should return correct Level 9 specs with linear mid-point speed ratios', () => {
  ...
  it('should enforce Level 17+ specs with max speed ratios (0.0s fright duration and 0 flashes)', () => {
