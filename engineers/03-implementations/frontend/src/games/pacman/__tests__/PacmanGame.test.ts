...
import { createPacmanGame, PacmanGame } from '../index';
...
describe('PacmanGame Entry Point Unit Tests', () => {
  let container: HTMLDivElement;
  let gameInstance: PacmanGame;

  beforeEach(() => {
    container = document.createElement('div');
    container.id = 'game-container';
    document.body.appendChild(container);
    gameInstance = createPacmanGame(container) as PacmanGame;
  });
  ...
  it('should instantiate PacmanGame successfully', () => {
