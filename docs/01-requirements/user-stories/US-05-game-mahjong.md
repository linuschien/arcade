...
- **AC2 (Special Hand Eight Pairs)**：支援特殊牌型「嚦咕嚦咕（八對半）」（由 **7 組對子 + 1 組刻子** 組成，精確 17 張且手牌必須全門清無任何副露，$K=0$。16 張持 8 組對子時，聽手中 8 對任一張進第 3 張湊成刻子胡牌）。
...
- **AC2 (Concealed Triplets & Mutual Exclusion Rules)**：
  ...
  - **嚦咕嚦咕 (8台)**：不重複累加門清 (1台)、平胡 (2台)、碰碰胡 (4台) 或暗刻台。
- **AC3 (Strict Standard Win 5 Rules & Situational Fans)**：
  ...
  - **其餘獨立牌型與情境台**：混一色（4台）、碰碰胡（4台）、槓上開花（1台）、海底撈月（1台）、搶槓（1台）、天胡（16台）、地胡（8台）。
