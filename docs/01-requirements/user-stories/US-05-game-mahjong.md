...
- **AC3 (Action Menu UI Display & Interaction Flow)**：當場上發生事件時，手牌上方彈出動作選單：
  ...
  - **【碰】**：持相同 2 張牌且別家打出時亮起。
  - **【槓】**：持 3 張別家打出（明槓）或自身摸到 4 張/加槓時亮起；多組可槓時展開二級選單。
  - **【聽】**：達成聽牌時亮起聽牌託管按鈕。
...
- **AC2 (Melded Kong)**：手牌 3 張相同遇別家打出第 4 張時，牌家**可選擇宣告「大明槓」**，自牌尾補摸 1 張牌。
...
- **AC3 (Strict Standard Win 5 Rules & Situational Fans)**：
  ...
  - **其餘獨立牌型與情境台**：混一色（4台）、碰碰胡（4台）、槓上開花（1台）、海底撈月（1台）、搶槓（1台）、天胡（16台）、地胡（8台）、人胡（8台）。
