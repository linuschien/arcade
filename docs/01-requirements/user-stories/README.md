...
| **US-05-05** | 台灣麻將 500底/200台 結算 | 結算莊家台、牌型台與特殊事件台 | 500底/200台、莊家 $2N+1$ 責任、牌型役種互斥 |
...
| **US-05-11** | 標準搬風抓位與座位確認 | 擲骰與東南西北抽籤入座 | 3 骰擲點 $(S-1)\bmod 4$、抽籤入座東南西北 |
| **US-05-12** | 莊家擲骰、開門與配牌起點 | 莊家擲骰決定開門牌牆與抓牌起點 | 3 骰 $S$ 逆時針定開門、由右往左數 $S+1$ 墩、順時針配牌跳牌 |
