...
| **US-05-02** | 16 張胡牌型態驗證 | 判定 5 面子 + 1 眼或嚦咕嚦咕 | 17 張牌合法性驗收、八對半特殊役、詐胡賠付 |
| **US-05-03** | 動作優先權仲裁 | 仲裁吃、碰、槓、胡動作優先級 | 胡 > 碰/槓 > 吃、攔胡 (無一砲多響)、下家吃牌約束 |
| **US-05-04** | 暗槓、明槓、加槓與補牌機制 | 處理三種槓牌與牌尾補牌 | 4 張暗槓 (防搶槓)、明槓、加槓、搶槓胡判定 (+1台) |
| **US-05-05** | 台灣麻將 500底/200台 結算 | 結算莊家台、牌型台與特殊事件台 | 500底/200台、莊家 $2N+1$ 台、平胡/門清/自摸/混清一色/大三元/大四喜等完整台數表 |
| **US-05-06** | 聽牌判定與過水/摸牌解除 | 即時聽牌張計算與過水約束 | 聽牌張清單、過水鎖定榮和權利、摸非胡張解除 |
...
| **US-05-11** | 搬風抓位與座位確認 | 擲骰與東南西北抽籤入座 | 3 骰擲點、臨時東風位、抓位入座東南西北 |
| **US-05-12** | 莊家擲骰、開門與配牌起點 | 莊家擲骰決定開門牌牆與抓牌起點 | 3 骰 $S$ 逆時針定開門、由右往左數 $S+1$ 墩、順時針配牌跳牌 |
| **US-05-13** | 四圈一將流轉與打完一將判定 | 推進東南西北四圈與完整一將 | 東南西北四圈流轉、北風圈北家下莊一將結束、總籌碼結算 |
| **US-05-14** | 連莊與下莊狀態推進 | 判定連莊續任或下莊移交莊家標記 | 莊胡/自摸/流局連莊 ($2N+1$)、閒家胡牌下莊移交莊標記 |
| **US-05-15** | 圈風台與門風台即時役型判定 | 依當前圈風與門風判定字牌刻子加台 | 圈風刻子 1 台、門風刻子 1 台、雙東雙南等雙風刻子 2 台 |
