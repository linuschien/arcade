...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **L1** | 20.00s | 2500ms | 15000ms | 10 格 | 0 顆 | 0 根 | 12 格 | 正對起點 | **0.0%** | **15.0%** | **85.0%** (各12.1%) |
| **L5** | 18.40s | 2300ms | 13800ms | 13 格 | 1 顆 | 0 根 | 10 格 | 正對起點 | **0.0%** | **13.8%** | **86.2%** |
| **L8** | 17.20s | 2150ms | 12900ms | 15 格 | 2 顆 | 0 根 | 10 格 | 正對起點 | **0.0%** | **12.9%** | **87.1%** |
| **L9** | 16.80s | 2100ms | 12600ms | 16 格 | 2 顆 | 1 根 | 9 格 | 垂直正交 | **0.7%** | **12.6%** | **86.7%** |
| **L15** | 14.40s | 1800ms | 10800ms | 21 格 | 4 顆 | 2 根 | 8 格 | 垂直正交 | **5.0%** | **10.8%** | **84.2%** |
| **L20** | 12.40s | 1550ms | 9300ms | 26 格 | 6 顆 | 3 根 | 6 格 | 垂直正交 | **8.6%** | **9.3%** | **82.1%** |
| **L21** | 12.00s | 1500ms | 9000ms | 27 格 | 7 顆 | 3 根 | 6 格 | 背向起點 | **9.4%** | **9.0%** | **81.6%** |
| **L28** | 9.20s | 1150ms | 6900ms | 32 格 | 9 顆 | 4 根 | 4 格 | 背向起點 | **14.4%** | **6.9%** | **78.7%** |
| **L36** | 6.00s | 800ms | 4800ms | 40 格 | 12 顆 | 5 根 | 2 格 | 背向起點 | **20.0%** | **5.0%** | **75.0%** (各10.7%) |
